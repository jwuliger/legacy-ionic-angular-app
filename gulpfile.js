...
var paths = {
	...
	scripts: [ "source/app/app.module.js", "source/app/**/*module.js", "source/app/**/*.js" ],
	styles: "source/css/**/*.*",
	...
	lib: "www/lib/**/*.*",
	//Destination folders
	destImages: "./www/images/",
	destTemplates: "./www/app/"
};

gulp.task( "default", [ "templatecache" ] );
//gulp.task("default", ["index", "templates", "styles", "images", "lib", "scripts"]); //"sass"
...
//		.pipe(templateCache("view.bundle.js", { module: "app.view.bundle", standalone: true, root: "app/" }))
//		.pipe(gulp.dest("www/build/"))
//		.pipe(notify({ message: "Template Cache built" }));
//});
...
gulp.task( "watch", function () {
	...
	gulp.watch( paths.templates, function ( event ) {
		var destPathFile = path.join( "./www", path.relative( path.join( __dirname, "./source" ), event.path ) );
